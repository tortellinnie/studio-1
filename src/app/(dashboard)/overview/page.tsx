...
import { getStatsForPeriod, totalCacheCount, personaInsights, sentimentTrends } from "@/data/mockData";
    ...
    <div className="space-y-12 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <h1 className="text-5xl font-black text-slate-900 tracking-tight">Market Intelligence Hub</h1>
      ...
      {/* Sentiment Analysis Feature Block */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="glass-card overflow-hidden">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  <span className="text-[10px] font-black text-slate-400 uppercase">Taglish Nuance</span>
          ...
          <Card className="glass-card overflow-hidden">
            ...
            <CardContent className="p-8 space-y-6 text-slate-900">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">Social Strategist</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-900 p-5 space-y-3">
                  ...
                  <Button className="w-full py-2 bg-white/10 hover:bg-white/20 text-white text-[9px] font-black uppercase tracking-widest transition-all rounded-none">Copy Response</Button>
                </div>
              </div>
            </CardContent>
          </Card>
