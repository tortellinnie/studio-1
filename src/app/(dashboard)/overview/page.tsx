  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 text-sm font-medium max-w-4xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <Card className="lg:col-span-4 border-slate-200 shadow-sm rounded-xl bg-white flex flex-col items-center p-8">
          <h3 className="text-lg font-bold text-slate-900 mb-8 w-full text-center">Overall customer sentiment level</h3>
          <div className="relative h-48 w-full max-w-[240px]">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-center">
              <p className="text-4xl font-extrabold text-slate-900 tracking-normal">{stats.correctedRating.toFixed(2)}</p>
              <p className="text-sm font-bold text-slate-400">Out of 5</p>
              <p className={cn("text-lg font-bold mt-1", gaugeValue > 66 ? 'text-emerald-500' : gaugeValue > 33 ? 'text-amber-500' : 'text-red-500')}>
        ...
        <Card className="lg:col-span-5 border-slate-200 shadow-sm rounded-xl bg-white p-8">
          <h3 className="text-lg font-bold text-slate-900 mb-2 text-center w-full">Comments on public posts</h3>
          ...
          <div className="flex flex-col p-1 bg-slate-100 rounded-lg border border-slate-200">
            {[
              ...
              <button
                ...
                className={cn(
                  "w-full py-2 text-sm font-bold transition-all rounded-md tracking-normal text-left px-4",
                  period === p.id 
          ...
          <div className="flex-1 grid grid-rows-2 gap-4">
            <Card className="bg-[#f59e0b] border-none flex flex-col justify-center p-6 text-white shadow-lg">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-xl font-bold leading-none">43.63%</p>
            ...
            <Card className="bg-[#003da5] border-none flex flex-col justify-center p-6 text-white shadow-lg">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-xl font-bold leading-none">36.88%</p>
                  <TrendingUp className="h-4 w-4 ml-auto mt-1" />
                </div>
              </div>
            </Card>
      ...
      <Card className="border-slate-200 shadow-sm rounded-xl bg-white overflow-hidden">
        <CardHeader className="pb-10 pt-8 px-8 flex flex-row items-center justify-between">
          <div className="space-y-1">
            <CardTitle className="text-xl font-bold text-slate-900 tracking-normal">Analysis timeline</CardTitle>
          ...
          <Badge variant="outline" className="text-xs font-bold py-1.5 px-3 text-slate-500 border-slate-200 tracking-normal">Validated NLP</Badge>
        </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="border-slate-200 shadow-sm rounded-xl bg-white p-8">
          <CardHeader className="px-0 pt-0">
            ...
            <CardDescription className="text-base text-slate-500 font-medium">Total market distribution breakdown</CardDescription>
          </CardHeader>
        ...
        <Card className="border-slate-200 shadow-sm rounded-xl bg-white p-8">
          <CardHeader className="px-0 pt-0 flex flex-row items-center justify-between">
            <div className="space-y-1">
              ...
              <CardDescription className="text-base text-slate-500 font-medium">NLP distribution across 5 core vectors</CardDescription>
            </div>
