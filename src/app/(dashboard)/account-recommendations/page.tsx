  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500 max-w-[1400px] mx-auto pb-10">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Account-Level Recommendations</h1>
      ...
      <Card className="shadow-sm border-l-4 border-l-[#003da5] border-slate-200 overflow-hidden bg-white">
        <CardHeader className="flex flex-row items-center justify-between py-8 px-10 border-b border-slate-50">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-2xl font-bold">Lazada</CardTitle>
            </div>
          ...
          <div className="text-right">
            ...
            <p className="text-6xl font-extrabold text-[#003da5]">92</p>
          </div>
        </CardHeader>
        <CardContent className="p-10 space-y-12">
          <div className="space-y-6">
            <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Top Performing Products</h4>
          ...
          <div className="space-y-6 pt-8 border-t border-slate-50">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Recommended Actions</h4>
            </div>
