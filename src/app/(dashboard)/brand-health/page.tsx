  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500 max-w-[1400px] mx-auto pb-10 px-4">
      <div className="space-y-1">
        <h1 className="text-3xl font-black tracking-tighter text-slate-900 font-headline uppercase">Market Health & Superiority Mapping</h1>
        <p className="text-base text-muted-foreground font-bold uppercase tracking-widest">Real-time vector distribution based on {totalCacheCount.toLocaleString()} NLP samples</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <Card className="lg:col-span-7 shadow-sm border-slate-200 bg-white overflow-hidden">
          <CardHeader className="bg-slate-50/50 border-b border-slate-100 py-6 px-8">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-emerald-500 text-white font-black uppercase tracking-widest px-4 py-1 text-[9px] rounded-lg">Live Market Feed</Badge>
            </div>
          </CardHeader>
          <CardContent className="p-10 flex flex-col items-center">
            ...
            <div className="grid grid-cols-3 w-full gap-8 mt-10 border-t border-slate-50 pt-10">
              ...
              <div className="text-center">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Superiority Anchor</p>
        ...
        {/* Promo Prioritization (Moved here) */}
        <div className="lg:col-span-5 space-y-8">
          <div className="flex items-center gap-4 mb-2">
            <div className="p-2 bg-[#003da5] rounded-lg">
              <Tag className="h-5 w-5 text-white" />
            </div>
            <h2 className="text-2xl font-black tracking-tight text-slate-900 font-headline uppercase tracking-tighter">SKU Promo Priorities</h2>
          </div>
          
          <div className="space-y-4">
            {promoRecommendations.slice(0, 4).map((promo, idx) => (
              <Card key={idx} className="border-l-4 border-l-[#003da5] bg-white shadow-sm hover:shadow-md transition-all">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div className="space-y-1">
                      <h3 className="text-lg font-black text-slate-900 tracking-tighter">{promo.sku}</h3>
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Health Index: {promo.currentSentiment}</p>
                    </div>
                    <Badge className={cn(
                  ...
                  <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
                    ...
                    <div>
                      <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Recommended Promo</p>
                      <p className="text-sm font-black text-slate-700 uppercase tracking-tight">{promo.recommendedPromo}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
